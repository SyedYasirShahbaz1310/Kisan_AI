...
echo "   # From your Kisan_AI directory, copy these files:"
echo "   cp Dockerfile app.py kisan_assistant.py \\"
echo "      index_knowledge.py knowledge_watcher.py \\"
echo "      requirements.txt .dockerignore \\"
echo "      ../\$SPACE_NAME/"
echo "   cp -r static ../\$SPACE_NAME/"
echo ""
